            ...
            <table style="border-collapse: collapse; font-size: 13px; " width="100%">
                ...
                <tr>
                    ...
                    <tr style="padding: 0px">
                        ...
                        <td style="padding: 0px;border-left: 1px solid #000000;border-bottom: 1px solid #000000;width:15%;<?php echo $font ?> ">&nbsp;<b></b></td>
                        <td style="border-left: 1px solid #000000;border-bottom: 1px solid #000000;width:2%"></td>
                        <td style="border-left: 1px solid #000000;border-bottom: 1px solid #000000;width:13%"></td>
                    </tr>
                    <tr style="padding: 0px;">
                    ...
                    <tr ng-if="form.jenis == 'Small Bus'">
                        ...
                        <td style="padding: 1px;border-left: 1px solid #000000;border-bottom: 1px solid #000000;width:15%;<?php echo $font ?>;"><b></b></td>
                        <td style="border-left: 1px solid #000000;border-bottom: 1px solid #000000;width:2%;"></td>
                        <td style="border-left: 1px solid #000000;border-bottom: 1px solid #000000;width:13%;"></td>
                    </tr>
                    <tr ng-if="form.jenis == 'Small Bus'">
