...
<tr>
    ...
    <td class="border-right border-bottom" style="text-align: center;">ACH</td>
...
<table style="border-collapse: collapse; border: 1px #000 solid; font-size: 12px;" width='100%'>
    ...
    foreach ($data as $val) {
        ?>
        <tr><td class="border-right border-bottom" colspan="11" bgcolor='#999999'><b><?= $val['title'] ?></b></td></tr>
        <?php
        $no = 1;
