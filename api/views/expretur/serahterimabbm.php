    ...
    <table class="border-all" style="border-collapse: collapse; margin-top: -2px; font-size: 11px;" width="100%">
        ...
        <tbody>
            ...
            foreach ($models as $key => $val) {
                if (isset($models[$key + 1]) and ($models[$key + 1]['nama_supplier'] == $val['nama_supplier'] and $models[$key + 1]['no_bbm'] == $val['no_bbm'])) {
                    $border = '';
                } else {
                ...
                if (isset($models[$key + 1]) and $models[$key + 1]['no_bbm'] != $val['no_bbm']) {
                    ...
                    echo '<td class="border-right ' . $border . '" align="center">' . $val['no_bbm'] . '</td>';
