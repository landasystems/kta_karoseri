		    ...
		    if($params['order']=="false")
		     ...
		     $sort.=" asc";
               ...
               $query->offset($offset)
	             ->limit($limit)
	             ->from('model')
	             ->andFilterWhere(['like', 'kd_model', $filter['kd_model']])
	             ->andFilterWhere(['like', 'model', $filter['model']])
	             ->andFilterWhere(['like', 'standard', $filter['standard']])
	             ->orderBy($sort)
	             ->select("kd_model,model,standard");
