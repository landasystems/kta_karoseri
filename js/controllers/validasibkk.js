app.controller('validasibkkCtrl', function ($scope, Data, toaster) {
    ...
    $scope.callServer = function callServer(tableState) {
        ...
        paramRef = param;
        Data.get('validasibkk', param).then(function (data) {
...
//        console.log(form);
        if (confirm("Apa anda yakin akan memproses item ini ?")) {
            Data.post('validasibkk/create/', form).then(function (result) {
                if (result.status == 0) {
