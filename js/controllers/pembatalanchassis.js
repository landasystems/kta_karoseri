app.controller('pembatalanchassisCtrl', function ($scope, Data, toaster) {
    ...
    $scope.excel = function () {
        Data.get('pembatalanchassis', paramRef).then(function (data) {
            window.location = 'api/web/pembatalanchassis/excel';
        });
    }
